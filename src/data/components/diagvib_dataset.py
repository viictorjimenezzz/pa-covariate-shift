...
PROCMNIST_PATH = "./data/dg/mnist_processed.npz"
...
ds1 = DiagVib6DatasetPA(
    ...
    dataset_specs_path="data/dg/dg_datasets/submission/toy_dataset/test_1.csv",
    t='test',
    split_numsplit=[0,1],
...
ds2 = DiagVib6DatasetPA(
    mnist_preprocessed_path=PROCMNIST_PATH,
    dataset_specs_path="data/dg/dg_datasets/submission/toy_dataset/test_2.csv",
    t='test',
    split_numsplit=[0,1],
    train_val_sequential=True
)
...
for i in range(4):
    image, target = ds1.__getitem__(i)
    title = 'CSV_1_' + str(i) + "_" + str(target)
    plt.imshow(image.permute(1, 2, 0))
    plt.savefig(title)

    image, target = ds2.__getitem__(i)
    title = 'CSV_2_' + str(i) + "_" + str(target)
    plt.imshow(image.permute(1, 2, 0))
    plt.savefig(title)
"""