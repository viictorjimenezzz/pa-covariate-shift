...
# SHARED_LOADPATH_MNIST = '/cluster/project/jbuhmann/jcarvalho/diagvib/mnist/mnist.npz'
SHARED_LOADPATH_MNIST = '/cluster/home/jcarvalho/projects/adv_pa/data/diagvib/mnist/mnist.npz'
# SHARED_SAVEPATH_MNIST = '/cluster/project/jbuhmann/jcarvalho/diagvib/mnist/mnist_processed.npz'
SHARED_SAVEPATH_MNIST = '/cluster/home/jcarvalho/projects/adv_pa/data/diagvib/mnist/mnist_processed.npz'
# Folder to store datasets for studies.
SHARED_STUDY_PATH = '/cluster/home/jcarvalho/projects/adv_pa/data/diagvib/studies_selected/'
# Path to the local textures in the repository.
# TEXTURE_PATH = '/cluster/home/jcarvalho/projects/irl-wilds/src/datamodules/components/diagvibsix/dataset/textures'
TEXTURE_PATH = '/cluster/home/jcarvalho/projects/adv_pa/src/data/components/diagvibsix/dataset/textures'
# Path to the selected factor classes
# SELECTED_CLASSES_PATH = '/cluster/home/jcarvalho/projects/irl-wilds/src/datamodules/components/diagvibsix/dataset/selected_classes.yml'
SELECTED_CLASSES_PATH = '/cluster/home/jcarvalho/projects/adv_pa/src/data/components/diagvibsix/dataset/selected_classes.yml'
# Path to selected generalization opportunities
# SELECTED_GENOPPS_PATH = '/cluster/home/jcarvalho/projects/irl-wilds/src/datamodules/components/diagvibsix/dataset/selected_genops.yml'
SELECTED_GENOPPS_PATH = '/cluster/home/jcarvalho/projects/adv_pa/src/data/components/diagvibsix/dataset/selected_genops.yml'
