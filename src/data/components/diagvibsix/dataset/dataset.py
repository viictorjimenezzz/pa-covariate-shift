...
from src.data.components.diagvibsix.auxiliaries import load_obj, save_obj
from src.data.components.diagvibsix.dataset.paint_images import Painter
...
from src.data.components.diagvibsix.dataset.dataset_utils import sample_attribute
from src.data.components.diagvibsix.dataset.config import DATASETS
